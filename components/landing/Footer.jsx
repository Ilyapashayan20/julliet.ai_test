...
export function Footer() {
  return (
    <footer className="bg-slate-50">
      <Container>
        <div className="py-16">
          <div className="flex flex-col items-center justify-center max-w-2xl mx-auto lg:flex-row">
            <Logo className="w-32 h-10 mx-auto" />
          </div>
          <nav className="mt-10" aria-label="quick links">
            <div className="justify-center -my-1 md:flex gap-x-6">
              <NavLink href="#features">Características</NavLink>
              <NavLink href="#testimonials">Testimonios</NavLink>
              <NavLink href="#faq">FAQ</NavLink>
              <NavLink href="/blog">Blog</NavLink>
              <NavLink href="/terms-and-conditions">Términos</NavLink>
        ...
        <div className="flex flex-col items-center py-10 border-t border-slate-400/10 sm:flex-row-reverse sm:justify-between">
          ...
          <p className="mt-6 text-sm text-slate-500 sm:mt-0">
            Copyright &copy; {new Date().getFullYear()} Crubing LLC. Todos los
            derechos reservados.
          </p>
        </div>
      </Container>
